...
const Environment = () => {
  return (
    <div className="outer-container">
      <div className="relative w-full min-h-screen bg-[#F1F0EA] max-w-full flex flex-row items-center justify-center gap-5 text-[#006240]">
        <motion.div
          initial={{
            y: 100,
            opacity: 0,
        ...
        >
          ...
          <p className="text-lg leading-relaxed font-sodo-sans font-normal not-italic text-center z-[2] ">
            Starbucks is committed to sustainability and helping the planet. We
            ethically source our coffee, caring for the environment and
            communities. We reduce waste with recyclable and reusable packaging
          ...
          <p className="mt-[-5rem] text-lg leading-relaxed font-sodo-sans font-normal  not-italic text-center z-[2]">
            We invest in renewable energy and make our stores energy-efficient.
            Starbucks also supports reforestation and water conservation
            projects, working towards a greener future for everyone.
          </p>
