...
//   const updateStopPosition = (width, height) => {
//     let newPosition;
//     if (width <= 280) {
//       newPosition = height * 0.5; // For very small screens
//     } else if (width <= 400) {
//       newPosition = height * 0.6; // For small screens
//     } else if (width <= 550) {
//       newPosition = height * 0.6; // For small screens
//     } else if (width <= 700) {
//       newPosition = height * 0.62; // For medium screens
//     } else if (width <= 1000) {
//       newPosition = height * 0.585; // For medium screens
//     } else if (width <= 1300) {
//       newPosition = height * 0.65; // For large screens
//     } else if (width <= 1600) {
//       newPosition = height * 0.6; // For large screens
//     } else {
//       newPosition = height * 0.75; // For very large screens
//     }
//     setStopPosition(newPosition);
//   };
...
//       newRadius = width * 0.15; // For medium screens
//     } else if (height <= 1000) {
//       newRadius = width * 0.2; // For large screens
//     } else if (height <= 1200) {
//       newRadius = width * 0.21; // For larger screens
//     } else {
//       newRadius = width * 0.24; // For very large screens
//     }
//     console.log("New Radius:", newRadius); // Log new calculated radius
//     setRadius(newRadius);
//   };
...
//       updateStopPosition(width, height);
...
//       const delay = i * delayIncrement;
//       const angleOffset = (i / additionalCups.length) * 2 * Math.PI; // Full circle offset
//       console.log("Radius for animation:", radius); // Log radius used in animation
//       animate(
//         `.cup-${i}`,
//         {
